...
class ObsXXQConan(ConanFile):
    ...
    def package(self):
        ...
        if self.settings.build_type=="Debug":
            ...
            self.copy("*.exe", dst="bin", src="build32/plugins/win-airplay/airplay/Debug", keep_path=False)
            self.copy("*.pdb", dst="bin", src="build32/plugins/win-airplay/airplay/Debug", keep_path=False)
            ...
            self.copy("*.exe", dst="bin", src="build32/plugins/win-airplay/iosqtvusbmirror/Debug", keep_path=False)
            self.copy("*.dll", dst="bin", src="build32/plugins/win-airplay/iosqtvusbmirror/Debug", keep_path=False)
            self.copy("*.pdb", dst="bin", src="build32/plugins/win-airplay/iosqtvusbmirror/Debug", keep_path=False)
            ...
            self.copy("*.dll", dst="plugins/obs-plugins/32bit", src="build32/plugins/beauty-filter/Debug", keep_path=False)
            self.copy("*.pdb", dst="plugins/obs-plugins/32bit", src="build32/plugins/beauty-filter/Debug", keep_path=False)
            ...
            self.copy("*.exe", dst="bin", src="build32/plugins/win-airplay/airplay/RelWithDebInfo", keep_path=False)
            self.copy("*.pdb", dst="bin", src="build32/plugins/win-airplay/airplay/RelWithDebInfo", keep_path=False)
            ...
            self.copy("*.exe", dst="bin", src="build32/plugins/win-airplay/iosqtvusbmirror/RelWithDebInfo", keep_path=False)
            self.copy("*.dll", dst="bin", src="build32/plugins/win-airplay/iosqtvusbmirror/RelWithDebInfo", keep_path=False)
            self.copy("*.pdb", dst="bin", src="build32/plugins/win-airplay/iosqtvusbmirror/RelWithDebInfo", keep_path=False)
            ...
            self.copy("*.dll", dst="plugins/obs-plugins/32bit", src="build32/plugins/beauty-filter/RelWithDebInfo", keep_path=False)
            self.copy("*.pdb", dst="plugins/obs-plugins/32bit", src="build32/plugins/beauty-filter/RelWithDebInfo", keep_path=False)
