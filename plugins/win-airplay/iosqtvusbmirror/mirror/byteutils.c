...
/**
 * Writes a little endian unsigned 64 bit integer to the buffer at position offset
 */
void byteutils_put_long(unsigned char* b, int offset, uint64_t value)
{
	*((uint64_t*)(b + offset)) = value;
}
