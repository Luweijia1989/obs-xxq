...
*/
typedef void (*tscb)(void *p, uint8_t *data, size_t size);
class SrsTsContext
{
// codec
private:
...
public:
    ...
    void setWriteCallback(tscb cb, void *data);
public:
    /**
...
public:
    ...
    */
    virtual int encode(SrsTsMessage* msg, SrsCodecVideo vc, SrsCodecAudio ac);
private:
    virtual int encode_pat_pmt(int16_t vpid, SrsTsStream vs, int16_t apid, SrsTsStream as);
    virtual int encode_pes(SrsTsMessage* msg, int16_t pid, SrsTsStream sid, bool pure_audio);
...
public:
    ...
    */
    int16_t PES_packet_length; //16bits
...
private:
    ...
    virtual int encode_33bits_dts_pts(SrsStream* stream, uint8_t fb, int64_t v);
};
...
public:
    ...
    */
    int16_t transport_stream_id; //16bits
