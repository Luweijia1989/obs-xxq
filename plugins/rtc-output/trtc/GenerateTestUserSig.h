...
public:
    ...
    * 它是腾讯云用于区分客户的唯一标识。
    */
    static const int SDKAPPID = 1400467335;
    ...
    */
    const std::string SECRETKEY = "aa49e3c5ddcb9e2033014fcfb3da7eed80ebfd0111c08839f25d5b3ffa6bd316";
    ...
    */
    static const int APPID = 1259626909;
    static const int BIZID = 67008;
