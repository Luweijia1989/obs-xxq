...
enum bef_ai_hair_param_type
{
    BEF_HAIR_DetectMode = 0,
    BEF_HAIRF_OutputMinSideLen = 1,
    BEF_HAIR_RefineBoundary = 2,
    BEF_HAIR_GaussianKsize = 3,
    BEF_HAIR_GaussianSigma = 4,
    BEF_HAIR_GaussianScale = 5,
    BEF_HAIR_GaussianKsizeOutside = 6,
    BEF_HAIR_GaussianSigmaOutside = 7,
    BEF_HAIR_GaussianScaleOutside = 8,
};
...
/*
 * @brief 设置SDK参数
 * type 类型，参照bef_ai_hair_param_type定义
 * value 设置参数对应的值
 **/
BEF_SDK_API bef_effect_result_t
bef_effect_ai_hairparser_set_paramNew(
                                    bef_effect_handle_t handle,
                                    bef_ai_hair_param_type type,
                                    int value);
...
/*
 * * @brief 获取输出mask shape
 * input_width, input_height 输入的图片大小 
 * output_width, output_height 用于得到 bef_effect_ai_hairparser_do_detect 接口输出的
 */
BEF_SDK_API bef_effect_result_t
bef_effect_ai_hairparser_get_output_shape_with_input(bef_effect_handle_t handle,
                                                     int input_width,
                                                     int input_height,
                                                     int* output_width,
                                                     int* output_height);
