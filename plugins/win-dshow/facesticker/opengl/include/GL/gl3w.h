...
/* gl3w api */
__declspec(dllexport)int gl3wInit(void);
__declspec(dllexport)int gl3wInitWithPath(const char *filename);
...
extern __declspec(dllimport)union GL3WProcs gl3wProcs;
...
#define glIsFramebufferEXT                               gl3wProcs.gl.IsFramebufferEXT
#define glGenFramebuffersEXT                             gl3wProcs.gl.GenFramebuffersEXT
#define glBindFramebufferEXT                             gl3wProcs.gl.BindFramebufferEXT
#define glFramebufferTexture2DEXT                        gl3wProcs.gl.FramebufferTexture2DEXT
#define glDeleteFramebuffersEXT                          gl3wProcs.gl.DeleteFramebuffersEXT
#define glIsRenderbufferEXT                              gl3wProcs.gl.IsRenderbufferEXT
#define glGenRenderbuffersEXT                            gl3wProcs.gl.GenRenderbuffersEXT
#define glBindRenderbufferEXT                            gl3wProcs.gl.BindRenderbufferEXT
#define glDeleteRenderbuffersEXT                         gl3wProcs.gl.DeleteRenderbuffersEXT
