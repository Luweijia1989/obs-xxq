...
find_path(
  ...
  HINTS ENV DETOURS_PATH ${DETOURS_PATH} ${CMAKE_SOURCE_DIR}/${DETOURS_PATH}
        ${_DETOURS_INCLUDE_DIRS} ENV DepsPath${_lib_suffix} ENV DepsPath ${DepsPath${_lib_suffix}} ${DepsPath}
...
find_library(
  ...
  HINTS ENV DETOURS_PATH ${DETOURS_PATH} ${CMAKE_SOURCE_DIR}/${DETOURS_PATH}
        ${_DETOURS_LIBRARY_DIRS} ENV DepsPath${_lib_suffix} ENV DepsPath ${DepsPath${_lib_suffix}} ${DepsPath}
